...
client.on("guildMemberAdd", member => {
  const hosgeldin = new Discord.MessageEmbed()
   ...
   .setColor("#00ff00")
    .addField("**WebSitemiz**", "[Tıkla ](https://haven-tau.vercel.app/)")
...
client.on('ready', () => {
  ...
  // Oynuyor Kısmı
      ...
      var actvs = [
        `${prefix}yardım Komutlarınızı`,
        `${prefix}yardım 7/24 Hizmet `, 
        `${prefix}yardım HAVEN #BASLANGIC`
    ];
    ...
    setInterval(() => {
      ...
      console.log (`Haven              : Gelişmiş bot alt yapı!`);
      console.log ('_________________________________________');
